...
urlpatterns = patterns('vocabulary.views',
    ...
    url(r'^(?P<vocab_node_id>[a-z0-9-_]+)/ordering$', 'ordering', name='ordering'),
       (r'^(?P<vocab_node_id>[a-z0-9-_]+)/new$',      'concept_new'),
       (r'^(?P<vocab_node_id>[a-z0-9-_]+)/(?P<node_id>[A-Za-z0-9-: ]+)/new',    'concept_new'),
       (r'^(?P<vocab_node_id>[a-z0-9-_]+)/(?P<node_id>[A-Za-z0-9-: ]+)/edit',   'concept_edit'),
       (r'^(?P<vocab_node_id>[a-z0-9-_]+)/(?P<node_id>[A-Za-z0-9-: ]+)/adopt',  'concept_adopt'),
       (r'^(?P<vocab_node_id>[a-z0-9-_]+)/(?P<node_id>[A-Za-z0-9-: ]+)/delete', 'concept_delete'),
)